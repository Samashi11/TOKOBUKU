              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="" method="POST">
                    <div class="row">
                      <div class="col">
                        ...
                        <div class="mb-3">
                          <input type="text" value="<?= $book["nama_buku"] ?>" class="form-control" name="nama_buku"
                            placeholder="Nama Buku" aria-label="nama_buku Buku" aria-describedby="nama_buku Buku-addon">
                        </div>
                        <label>Kategori<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" value="<?= $book["kategori"] ?>" class="form-control" name="kategori"
                            placeholder="Kategori" aria-label="kategori" aria-describedby="kategori-addon">
                        </div>
                        <label>Kode<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" value="<?= $book["kode"] ?>" class="form-control" name="kode"
                      ...
                      <div class="col">
                        ...
                        <div class="form-group mb-3">
                          <select class="form-control <?php echo isset($errors['penerbit']) ? 'is-invalid' : ''; ?>"
                            ...
                            <option <?= $item["id"] == $book["penerbit_id"] ? "selected" : ""; ?>
                              value="<?= $item["id"]; ?>">
                              <?= $item["nama"]; ?>
                            </option>
                            <?php endforeach; ?>
                        ...
                        <div class="mb-3">
                          <input type="text" value="<?= $book["harga"] ?>" class="form-control" name="harga"
                            placeholder="Harga" aria-label="harga" aria-describedby="harga-addon">
                        </div>
                        <label>Stok<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" value="<?= $book["stok"] ?>" class="form-control" name="stok"
                    ...
                    <div class="text-center">
                      <button type="submit" name="ubah" class="btn bg-primary w-100 mt-4 mb-0"><i
                          class="fas fa-plus"></i>&nbsp;&nbsp;Update Buku</button>
                    </div>
                  </form>
                  <?php
                    }
                  ...
                  if (isset($_POST["ubah"])) {
                    ...
                    $query = "UPDATE buku SET kode = '$kode',kategori = '$kategori',nama_buku = '$nama_buku',harga ='$harga',stok ='$stok',penerbit_id ='$penerbit' WHERE id = $get";
