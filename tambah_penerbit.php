              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="" method="POST">
                    <div class="row">
                      <div class="col">
                        ...
                        <div class="mb-3">
                          <input type="text" class="form-control" name="nama" placeholder="Nama Penerbit"
                            aria-label="nama_buku Buku" aria-describedby="nama_buku Buku-addon">
                        </div>
                        <label>ID Penerbit<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" class="form-control" name="kode" placeholder="ID Penerbit"
                            aria-label="kategori" aria-describedby="kategori-addon">
                        </div>
                      ...
                      <div class="col">
                        ...
                        <div class="mb-3">
                          <input type="text" class="form-control" name="kota" placeholder="Kota" aria-label="harga"
                            aria-describedby="harga-addon">
                        </div>
                        <label>Telepon<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" class="form-control" name="telepon" placeholder="Telepon" aria-label="stok"
                            aria-describedby="stok-addon">
                        </div>
                      </div>
                    </div>
                    <div class="text-center">
                      <button type="submit" name="tambah" class="btn bg-primary w-100 mt-4 mb-0"><i
                          class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Penerbit</button>
                    </div>
                  </form>
                  <?php
                  if (isset($_POST["tambah"])) {
                    ...
                    $query = "INSERT INTO penerbit(kode,alamat,nama,kota,telepon)
                    VALUES ('$kode','$alamat','$nama','$kota','$telepon')";
