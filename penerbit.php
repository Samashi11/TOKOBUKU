            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <a class="pt-3" href="tambah_penerbit.php">
                    <button class="btn btn-success mb-3 font-weight-bold">Tambah Penerbit</button>
                  </a>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-responsive-sm">
                      <thead>
                        <tr>
                          <th class="text-dark">ID Penerbit</th>
                          <th class="text-dark">Nama Penerbit</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th><?= $nerbit["alamat"] ?></th>
                          <th><?= $nerbit["kota"] ?></th>
                          <th><?= $nerbit["telepon"] ?></th>
                          <th class="d-flex justify-content-end">
                            <a href="edit_penerbit.php?id=<?=$nerbit["id"]?>" class="btn btn-warning">
                              <i class="fa fa-xl fa-pencil"></i>
                            </a>
                            <a href="hapus_penerbit.php?id=<?=$nerbit["id"]?>"
