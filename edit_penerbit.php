              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="" method="POST">
                    <div class="row">
                      <div class="col">
                        ...
                        <div class="mb-3">
                          <input type="text" class="form-control" value="<?=$nerbit["nama"]?>" name="nama"
                            placeholder="Nama Penerbit" aria-label="nama_buku Buku"
                            aria-describedby="nama_buku Buku-addon">
                        </div>
                        <label>ID Penerbit<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" class="form-control" value="<?=$nerbit["kode"]?>" name="kode"
                            placeholder="ID Penerbit" aria-label="kategori" aria-describedby="kategori-addon">
                        </div>
                        <label>Alamat<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" class="form-control" value="<?=$nerbit["alamat"]?>" name="alamat"
                            placeholder="Alamat" aria-label="alamat" aria-describedby="kode-addon">
                        </div>
                      </div>
                      <div class="col">
                        <label>Kota<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" class="form-control" value="<?=$nerbit["kota"]?>" name="kota"
                            placeholder="Kota" aria-label="harga" aria-describedby="harga-addon">
                        </div>
                        <label>Telepon<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                          <input type="text" class="form-control" value="<?=$nerbit["telepon"]?>" name="telepon"
                            placeholder="Telepon" aria-label="stok" aria-describedby="stok-addon">
                        </div>
                      </div>
                    </div>
                    <div class="text-center">
                      <button type="submit" name="ubah" class="btn bg-primary w-100 mt-4 mb-0"><i
                          class="fas fa-plus"></i>&nbsp;&nbsp;Ubah Penerbit</button>
                    </div>
                  </form>
                  <?php
                    }
                  ...
                  if (isset($_POST["ubah"])) {
                    ...
                    $query = "UPDATE penerbit SET kode = '$kode',alamat = '$alamat',nama = '$nama',kota = '$kota',telepon ='$telepon'
                    WHERE id = $get";
