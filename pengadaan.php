...
$pengadaan = mysqli_query($connect,"SELECT * FROM buku ORDER BY stok ASC LIMIT 1")
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Data Pengadaan Buku</h4>
                </div>
                <div class="card-body">
